...
const ToggleButton: React.FC<CustomButtonProps> = ({
  ...
  return (
    ...
    >
      <svg
        className={`h-6 w-6 text-yellow-300 hover:fill-pink-500 hover:text-pink-500 ${selected ? 'fill-yellow-300' : 'fill-none'}`}
        width='1431'
        height='1691'
        fill=''
      ...
      >
        <title>
          toggle [TODO set/remove] [TODO add parent title] favorite status
        </title>
