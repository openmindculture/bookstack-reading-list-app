...
- The app should be designed in a way that it is easy to localize. This does not necessarily imply that there are no fixed strings or text blocks in a nonlocalized version.

### Tech Stack, Non-Functional Requirements

The app must be accessible, responsive, robust, maintainable, eco-friendly and load quickly.
...
## Astro Introduction (Minimal)

> 🧑‍🚀 **Seasoned astronaut?** Delete this section. Have fun!
